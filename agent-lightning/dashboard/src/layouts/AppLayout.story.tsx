...
const ROUTES = [
  {
    ...
    children: [
      ...
      {
        path: 'metrics',
        element: <Placeholder title='Metrics' description='Inspect episode reward and training loss.' />,
      },
      {
        path: 'science',
        element: <Placeholder title='Science MAS' description='Inspect collect JSON, harness, and TrainSignal.' />,
      },
      {
        path: 'resources',
...
export const ScienceNavActive: Story = {
  render: (args) => renderAppLayout(args, '/science'),
};
