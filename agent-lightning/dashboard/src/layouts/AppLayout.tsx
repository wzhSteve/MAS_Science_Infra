...
import { IconChartLine, IconCpu, IconFlask, IconRouteSquare, IconRun, IconSettings, IconTimeline } from '@tabler/icons-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Metrics', to: '/metrics', icon: <IconChartLine size={16} /> },
  { label: 'Science MAS', to: '/science', icon: <IconFlask size={16} /> },
