...
class Diagnoser:
    ...
    def verificate_context(self, question: str, image: str, target_information: str, outline: Dict[str, Any], result_executor: str, step_count: int = 0, obtained_information: Any = None, sub_goal: str = "", tool_name: str = "", intervention_context: Optional[Dict[str, Any]] = None) -> Any:
        """
        ...
        prompt_verificate_context = prompt_template.format(
            ...
            Memory="",  # Diagnoser不持有memory，使用空字符串
    ...
    def should_record_obtained_information(self,
        ...
        if step_conclusion == "SUBGOAL_INCOMPLETE":
            if self._has_valid_execution_data(result_executor, analysis):
                summary = self._create_execution_summary(result_executor, step_conclusion)
                if summary:
                    return True, summary
