...
class ChatOpenAI(EngineLM, CachedEngine):
    ...
    def __init__(
        ...
        **kwargs):
        ...
        # print("dotenv path =", find_dotenv(usecwd=True))
        self.model_string = os.getenv("MODEL_Name", model_string)
        ...
        self.SERVER_MODEL = os.getenv("SERVER_MODEL", "").split(",") if os.getenv("SERVER_MODEL") else []
        self.client = OpenAI(
    ...
    def _generate_text(
        ...
        elif self.model_string in self.SERVER_MODEL or (self.is_chat_model and (not self.support_structured_output or response_format is None)):
