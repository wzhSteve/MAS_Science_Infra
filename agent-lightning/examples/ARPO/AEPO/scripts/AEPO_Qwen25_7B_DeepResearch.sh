...
EXPERIMENT_NAME="aepo_qwen25_7b_deepresearch"
...
# Data file paths
TRAIN_FILES="${PARENT_DIR}/../ARPO/rl_datasets/train_10k.parquet" # Modify training data path
VALID_FILES="${PARENT_DIR}/../ARPO/rl_datasets/valid.parquet" # Modify validation data path

# ============================ Model Configuration ============================
# Actor model path
ACTOR_MODEL_PATH="<your_7B_model_path>"
...
# ============================ Path Configuration ============================
# Save path
SAVE_PATH="<your_checkpoint_save_dir>/rl/${EXPERIMENT_NAME}" # Modify save path
