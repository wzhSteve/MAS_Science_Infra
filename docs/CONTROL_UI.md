...
浏览器打开 [http://127.0.0.1:8787/](http://127.0.0.1:8787/) ，API 文档 `/docs`。

Branch / RAE / sites 验收清单见 [BRANCH_ROLLOUT_UI_TEST.md](./BRANCH_ROLLOUT_UI_TEST.md)。
MAS 页在主画布下方有 **Rollout Sampling** 轨迹小窗（选 branch 起点与 gate → `sampling.sites`）。
